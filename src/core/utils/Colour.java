...
public enum Colour {
	 ...
	 * 
	 * @param inText This is the text that we want to colour.
	 * 
	 ...
	 * 
	 * @return this returns the formatted string.
	 */
	public static String colour(String inText, Colour foreground, Colour background) {
