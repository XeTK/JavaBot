...
public class JSON {
	...
	private static final String TXT_FILE_SAVED = "\u001B[33mJSON Saved: ./ %s";
	 ...
	 */
	public static Object load(String in_Path, Class<?> classdef) throws IOException {
	 ...
	 */
	public static void save(String inPath, Object saveable) throws IOException {
		...
		System.out.println(String.format(TXT_FILE_SAVED,inPath));
	}
}