...
/**
 * This encapsulation of a Days worth of Stat hour's, it also tallies and updates
 * the various data for the day and current hour.
...
public class StatDay
{
	...
	/** 
	 * This method returns the current hour object for the hour 
